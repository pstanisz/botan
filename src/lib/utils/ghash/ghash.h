...
class GHASH final : public SymmetricAlgorithm {
   public:
      ...
      void nonce_hash(secure_vector<uint8_t>& y0, Botan::span<const uint8_t> nonce);
      ...
      */
      void update_associated_data(Botan::span<const uint8_t> ad);
      ...
      void ghash_update(secure_vector<uint8_t>& x, Botan::span<const uint8_t> input);
   ...
   private:
      ...
      void ghash_multiply(secure_vector<uint8_t>& x, Botan::span<const uint8_t> input, size_t blocks);
