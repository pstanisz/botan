...
class BOTAN_PUBLIC_API(2, 11) Flatfile_Certificate_Store final : public Certificate_Store
   ...
   public:
      ...
      */
      Flatfile_Certificate_Store(Botan::string_view file, bool ignore_non_ca = false);
   ...
   private:
      ...
      std::map<std::vector<uint8_t>, Botan::optional<X509_Certificate>> m_pubkey_sha1_to_cert;
      std::map<std::vector<uint8_t>, Botan::optional<X509_Certificate>> m_subject_dn_sha256_to_cert;
   };
}
