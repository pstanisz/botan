...
*/
bool x500_name_cmp(Botan::string_view name1, Botan::string_view name2)
   {
   auto p1 = name1.begin();
   auto p2 = name2.begin();
...
*/
void X509_DN::add_attribute(Botan::string_view type,
...
bool X509_DN::has_field(Botan::string_view attr) const
   {
   try
      {
...
std::string X509_DN::get_first_attribute(Botan::string_view attr) const
   {
...
*/
std::vector<std::string> X509_DN::get_attribute(Botan::string_view attr) const
   {
   const OID oid = OID::from_string(deref_info_field(attr));
...
*/
std::string X509_DN::deref_info_field(Botan::string_view info)
   {
