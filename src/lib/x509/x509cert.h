...
class BOTAN_PUBLIC_API(2,0) X509_Certificate : public X509_Object
   ...
   public:
      ...
      */
      std::vector<std::string> subject_info(Botan::string_view name) const;
      ...
      * @return value(s) of the specified parameter
      */
      std::vector<std::string> issuer_info(Botan::string_view name) const;
      ...
      */
      bool allowed_extended_usage(Botan::string_view usage) const;
      ...
      */
      bool has_ex_constraint(Botan::string_view ex_constraint) const;
      ...
      * certificate.
      */
      bool is_critical(Botan::string_view ex_name) const;
      ...
      */
      std::string fingerprint(Botan::string_view hash_name = "SHA-1") const;
      ...
      */
      bool matches_dns_name(Botan::string_view name) const;
      ...
      */
      explicit X509_Certificate(Botan::string_view filename);
#endif
