...
class BOTAN_PUBLIC_API(2,0) X509_Cert_Options final
   ...
   public:
      ...
      */
      void add_ex_constraint(Botan::string_view name);
      ...
      */
      X509_Cert_Options(Botan::string_view opts = "",
