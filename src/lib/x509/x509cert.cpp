...
X509_Certificate::X509_Certificate(Botan::string_view fsname)
   {
...
bool X509_Certificate::allowed_extended_usage(Botan::string_view usage) const
   {
...
bool X509_Certificate::has_ex_constraint(Botan::string_view ex_constraint) const
   {
...
*/
bool X509_Certificate::is_critical(Botan::string_view ex_name) const
   {
...
X509_Certificate::subject_info(Botan::string_view req) const
   {
   if(req == "Email")
...
*/
std::vector<std::string>
X509_Certificate::issuer_info(Botan::string_view req) const
   {
...
std::string X509_Certificate::fingerprint(Botan::string_view hash_name) const
   {
   /*
...
bool X509_Certificate::matches_dns_name(Botan::string_view name) const
   {
   if(name.empty())
      return false;
