...
BOTAN_PUBLIC_API(2,0) srp6_client_agree(Botan::string_view username,
...
std::pair<BigInt,SymmetricKey> BOTAN_PUBLIC_API(2,11)
   srp6_client_agree(Botan::string_view username,
                     Botan::string_view password,
...
BigInt BOTAN_PUBLIC_API(2,0)
   srp6_generate_verifier(Botan::string_view identifier,
                          Botan::string_view password,
                          const std::vector<uint8_t>& salt,
                          Botan::string_view group_id,
                          Botan::string_view hash_id);
