...
class MechanismWrapper final
   ...
   public:
      ...
      */
      static MechanismWrapper create_rsa_crypt_mechanism(Botan::string_view padding);
      ...
      */
      static MechanismWrapper create_rsa_sign_mechanism(Botan::string_view padding);
      ...
      */
      static MechanismWrapper create_ecdsa_mechanism(Botan::string_view hash);
      ...
      */
      static MechanismWrapper create_ecdh_mechanism(Botan::string_view params);
