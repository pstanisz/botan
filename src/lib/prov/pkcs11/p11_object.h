...
class BOTAN_PUBLIC_API(2,0) AttributeContainer
   ...
   public:
      ...
      */
      void add_string(AttributeType attribute, Botan::string_view value);
...
class BOTAN_PUBLIC_API(2,0) StorageObjectProperties : public ObjectProperties
   ...
   public:
      ...
      inline void set_label(Botan::string_view label)
         {
...
class BOTAN_PUBLIC_API(2,0) DataObjectProperties final : public StorageObjectProperties
   ...
   public:
      ...
      inline void set_application(Botan::string_view value)
         {
...
class BOTAN_PUBLIC_API(2,0) Object
   ...
   public:
      ...
      */
      ...
      template<typename T>
      static std::vector<T> search(Session& session, Botan::string_view label);
      ...
      template<typename T>
      static std::vector<T> search(Session& session, Botan::string_view label, const std::vector<uint8_t>& id);
...
template<typename T>
std::vector<T> Object::search(Session& session, Botan::string_view label)
   {
...
template<typename T>
std::vector<T> Object::search(Session& session, Botan::string_view label, const std::vector<uint8_t>& id)
   {
   AttributeContainer search_template(T::Class);
   search_template.add_string(AttributeType::Label, label);
   search_template.add_binary(AttributeType::Id, id);
