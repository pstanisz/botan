...
class BOTAN_PUBLIC_API(2,0) Module final
   ...
   public:
      ...
      */
      Module(Botan::string_view file_path, C_InitializeArgs init_args = { nullptr, nullptr, nullptr, nullptr, static_cast< CK_FLAGS >(Flag::OsLockingOk), nullptr });
...
class BOTAN_PUBLIC_API(2,0) Slot final
   ...
   public:
      ...
      */
      void initialize(Botan::string_view label, const secure_string& so_pin) const;
