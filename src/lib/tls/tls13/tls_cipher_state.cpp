...
secure_vector<uint8_t> Cipher_State::export_key(Botan::string_view label,
...
std::unique_ptr<MessageAuthenticationCode> create_hmac(Botan::string_view hash)
   {
...
Cipher_State::Cipher_State(Connection_Side whoami, Botan::string_view hash_function)
