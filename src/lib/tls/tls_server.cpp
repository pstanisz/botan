...
size_t Server::from_peer(Botan::span<const uint8_t> data)
   {
...
SymmetricKey Server::key_material_export(Botan::string_view label,
...
void Server::to_peer(Botan::span<const uint8_t> data)
   {
   m_impl->to_peer(data);
   }
