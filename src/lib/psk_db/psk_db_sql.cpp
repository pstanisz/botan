...
void Encrypted_PSK_Database_SQL::kv_del(Botan::string_view name)
   {
...
void Encrypted_PSK_Database_SQL::kv_set(Botan::string_view name, Botan::string_view value)
   {
...
std::string Encrypted_PSK_Database_SQL::kv_get(Botan::string_view name) const
   {
