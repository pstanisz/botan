...
Compression_Algorithm::create(Botan::string_view name)
   {
#if defined(BOTAN_HAS_ZLIB)
...
//static
std::unique_ptr<Compression_Algorithm>
Compression_Algorithm::create_or_throw(Botan::string_view algo)
   {
...
Decompression_Algorithm::create(Botan::string_view name)
   {
#if defined(BOTAN_HAS_ZLIB)
   if(name == "Zlib" || name == "zlib")
...
//static
std::unique_ptr<Decompression_Algorithm>
Decompression_Algorithm::create_or_throw(Botan::string_view algo)
   {
