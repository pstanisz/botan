...
class KEM_Encryption_with_KDF : public KEM_Encryption {
   public:
      void kem_encrypt(Botan::span<uint8_t> out_encapsulated_key,
                       Botan::span<uint8_t> out_shared_key,
                       RandomNumberGenerator& rng,
                       size_t desired_shared_key_len,
                       Botan::span<const uint8_t> salt) final;
   ...
   protected:
      virtual void raw_kem_encrypt(Botan::span<uint8_t> out_encapsulated_key,
                                   Botan::span<uint8_t> out_raw_shared_key,
...
class KEM_Decryption_with_KDF : public KEM_Decryption {
   public:
      void kem_decrypt(Botan::span<uint8_t> out_shared_key,
   ...
   protected:
      virtual void raw_kem_decrypt(Botan::span<uint8_t> out_raw_shared_key,
                                   Botan::span<const uint8_t> encapsulated_key) = 0;
