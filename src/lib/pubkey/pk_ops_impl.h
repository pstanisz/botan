...
class Encryption_with_EME : public Encryption
   ...
   protected:
      explicit Encryption_with_EME(Botan::string_view eme);
   private:
...
class Decryption_with_EME : public Decryption
   ...
   protected:
      explicit Decryption_with_EME(Botan::string_view eme);
   private:
...
class Verification_with_Hash : public Verification
   ...
   protected:
      explicit Verification_with_Hash(Botan::string_view hash);
...
class Signature_with_Hash : public Signature
   ...
   protected:
      explicit Signature_with_Hash(Botan::string_view hash);
...
class Key_Agreement_with_KDF : public Key_Agreement
   ...
   protected:
      explicit Key_Agreement_with_KDF(Botan::string_view kdf);
...
class KEM_Encryption_with_KDF : public KEM_Encryption
   ...
   protected:
      ...
      explicit KEM_Encryption_with_KDF(Botan::string_view kdf);
...
class KEM_Decryption_with_KDF : public KEM_Decryption
   ...
   protected:
      ...
      explicit KEM_Decryption_with_KDF(Botan::string_view kdf);
