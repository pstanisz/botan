...
DSA_PublicKey::DSA_PublicKey(const AlgorithmIdentifier& alg_id, Botan::span<const uint8_t> key_bits) {
...
DSA_PrivateKey::DSA_PrivateKey(const AlgorithmIdentifier& alg_id, Botan::span<const uint8_t> key_bits) {
