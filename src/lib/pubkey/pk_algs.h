...
*/
BOTAN_PUBLIC_API(2,0) std::unique_ptr<Private_Key>
create_private_key(Botan::string_view algo_name,
                   RandomNumberGenerator& rng,
                   Botan::string_view algo_params = "",
...
create_ec_private_key(Botan::string_view algo_name,
                      const EC_Group& group,
                      RandomNumberGenerator& rng);

BOTAN_PUBLIC_API(2,2)
std::vector<std::string>
probe_provider_private_key(Botan::string_view algo_name,
