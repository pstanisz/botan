...
void parse_sm2_param_string(Botan::string_view params,
                            std::string& userid,
                            std::string& hash)
   {
...
SM2_PublicKey::create_verification_op(Botan::string_view params,
