...
class XMSS_Hash final {
   ...
   public:
       ...
       **/
      inline void prf(secure_vector<uint8_t>& result, Botan::span<const uint8_t> key, Botan::span<const uint8_t> data) {
       ...
       **/
      void f(secure_vector<uint8_t>& result, Botan::span<const uint8_t> key, Botan::span<const uint8_t> data) {
       ...
       **/
      void h(secure_vector<uint8_t>& result, Botan::span<const uint8_t> key, Botan::span<const uint8_t> data) {
       ...
       **/
      secure_vector<uint8_t> h_msg(Botan::span<const uint8_t> randomness,
       ...
       * @param index_bytes Index value padded with leading zeros.
       **/
      void h_msg_init(Botan::span<const uint8_t> randomness,
                      Botan::span<const uint8_t> root,
                      Botan::span<const uint8_t> index_bytes);
       ...
       **/
      void h_msg_update(Botan::span<const uint8_t> data);
