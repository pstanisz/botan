...
class BOTAN_PUBLIC_API(3, 0) Kyber_PublicKey : public virtual Public_Key {
   public:
      ...
      Kyber_PublicKey(const AlgorithmIdentifier& alg_id, Botan::span<const uint8_t> key_bits);
   ...
   protected:
      ...
      static std::shared_ptr<Kyber_PublicKeyInternal> initialize_from_encoding(Botan::span<const uint8_t> pub_key,
                                                                               KyberMode m);
...
class BOTAN_PUBLIC_API(3, 0) Kyber_PrivateKey final : public virtual Kyber_PublicKey,
   ...
   public:
      ...
      Kyber_PrivateKey(const AlgorithmIdentifier& alg_id, Botan::span<const uint8_t> key_bits);
