...
class BOTAN_PUBLIC_API(2,0) ECIES_KA_Params
   ...
   public:
      ...
      */
      ECIES_KA_Params(const EC_Group& domain, Botan::string_view kdf_spec, size_t length,
...
class BOTAN_PUBLIC_API(2,0) ECIES_System_Params final : public ECIES_KA_Params
   ...
   public:
      ...
      */
      ECIES_System_Params(const EC_Group& domain, Botan::string_view kdf_spec, Botan::string_view dem_algo_spec,
                          size_t dem_key_len, Botan::string_view mac_spec, size_t mac_key_len);
