...
class BOTAN_PUBLIC_API(2,0) EC_Group final
   ...
   public:
      ...
      * EC_Group_from_PEM
      */
      explicit EC_Group(Botan::string_view pem_or_oid);

      static EC_Group EC_Group_from_PEM(Botan::string_view pem);
      ...
      */
      EC_Point hash_to_curve(Botan::string_view hash_fn,
                             const uint8_t input[],
                             size_t input_len,
      ...
      */
      ...
      EC_Point OS2ECP(Botan::span<const uint8_t> encoded_point) const
         {
