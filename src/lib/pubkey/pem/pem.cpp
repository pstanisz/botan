...
std::string linewrap(size_t width, Botan::string_view in)
   {
   std::string out;
...
*/
std::string encode(const uint8_t der[], size_t length, Botan::string_view label, size_t width)
   {
...
secure_vector<uint8_t> decode_check_label(Botan::string_view pem,
                                          Botan::string_view label_want)
   {
...
secure_vector<uint8_t> decode(Botan::string_view pem, std::string& label)
   {
   DataSource_Memory src(pem);
...
*/
bool matches(DataSource& source, Botan::string_view extra,
             size_t search_range)
   {
