...
class BOTAN_PUBLIC_API(2,0) PK_Encryptor
   ...
   public:
      ...
      * @return encrypted message
      */
      std::vector<uint8_t> encrypt(Botan::span<const uint8_t> in,
                                   RandomNumberGenerator& rng) const
         {
...
class BOTAN_PUBLIC_API(2,0) PK_Decryptor
   ...
   public:
      ...
      * @return decrypted message
      */
      secure_vector<uint8_t> decrypt(Botan::span<const uint8_t> in) const
         {
...
class BOTAN_PUBLIC_API(2,0) PK_Signer final
   ...
   public:
      ...
      * @return signature
      */
      std::vector<uint8_t> sign_message(Botan::span<const uint8_t> in,
                                        RandomNumberGenerator& rng)
         {
      ...
      * @param in the message part to add
      */
      void update(Botan::string_view in)
         {
...
class BOTAN_PUBLIC_API(2,0) PK_Verifier final
   ...
   public:
      ...
      * @return true if the signature is valid
      */
      bool verify_message(Botan::span<const uint8_t> msg,
      ...
      * @return true if the signature is valid, false otherwise
      */
      bool check_signature(Botan::span<const uint8_t> sig)
         {
   ...
   public:
      ...
      */
      SymmetricKey derive_key(size_t key_len,
                              ...
                              Botan::string_view params = "") const
         {
