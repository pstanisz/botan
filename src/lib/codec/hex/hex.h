...
* @return hexadecimal representation of input
*/
inline std::string hex_encode(Botan::span<const uint8_t> input, bool uppercase = true) {
...
* @return number of bytes written to output
*/
size_t BOTAN_PUBLIC_API(3, 0) hex_decode(Botan::span<uint8_t> output, std::string_view input, bool ignore_ws = true);
