...
ASN1_Time::ASN1_Time(Botan::string_view t_spec, ASN1_Type tag)
   {
   set_to(t_spec, tag);
   }

ASN1_Time::ASN1_Time(Botan::string_view t_spec)
   {
   if(t_spec.size() == 13)
...
void ASN1_Time::set_to(Botan::string_view t_spec, ASN1_Type spec_tag)
   {
