...
* ARIA Key Schedule
*/
void key_schedule(secure_vector<uint32_t>& ERK, secure_vector<uint32_t>& DRK, Botan::span<const uint8_t> key) {
...
void ARIA_128::key_schedule(Botan::span<const uint8_t> key) {
   ARIA_F::key_schedule(m_ERK, m_DRK, key);
}

void ARIA_192::key_schedule(Botan::span<const uint8_t> key) {
   ARIA_F::key_schedule(m_ERK, m_DRK, key);
}

void ARIA_256::key_schedule(Botan::span<const uint8_t> key) {
   ARIA_F::key_schedule(m_ERK, m_DRK, key);
}
