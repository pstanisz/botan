...
class BOTAN_UNSTABLE_API FFI_Error final : public Botan::Exception
   {
   public:
      FFI_Error(Botan::string_view what, int err_code) :
...
inline int write_str_output(uint8_t out[], size_t* out_len, Botan::string_view str)
   {
...
inline int write_str_output(char out[], size_t* out_len, Botan::string_view str)
   {
