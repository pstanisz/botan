...
template <typename T>
struct With_size_and_data : public With_size<T>,
                            With_data<T> {};

std::vector<Test::Result> test_ctors() {
   return {Botan_Tests::CHECK("default ctor",
                              [](auto& result) {
                                 Botan::span<int> s;
           ...
           Botan_Tests::CHECK("ctor with first and size",
                              [](auto& result) {
         ...
         result.test_is_eq("data()", s.data(), ARRAY.begin());
           ...
           Botan_Tests::CHECK("ctor with first and last",
                              [](auto& result) {
#if defined(BOTAN_BUILD_COMPILER_IS_MSVC)
         ...
         result.test_is_eq("data()", s.data(), ARRAY.begin());
           ...
           Botan_Tests::CHECK("ctor with C array",
                              [](auto& result) {
           ...
           Botan_Tests::CHECK("ctor with std::array",
                              [](auto& result) {
         ...
         result.test_is_eq("data()", s.data(), ARRAY.begin());
           ...
           Botan_Tests::CHECK("ctor with const std::array",
                              [](auto& result) {
         ...
         result.test_is_eq("data()", s.data(), CONST_ARRAY.begin());
           ...
           Botan_Tests::CHECK("ctor with std::vector",
                              [](auto& result) {
                                 Botan::span<int> s(VECTOR);

                                 result.test_is_eq("size()", s.size(), VECTOR.size());
                              }),
           Botan_Tests::CHECK("ctor with const std::vector",
                              [](auto& result) {
...
std::vector<Test::Result> test_assignment_operator() {
   return {Botan_Tests::CHECK("operator= from empty",
                              [](auto& result) {
                                 Botan::span<int> s;
                                 Botan::span<int> s1;
...
std::vector<Test::Result> test_iterators() {
   return {Botan_Tests::CHECK("begin() and end() with empty",
                              [](auto& result) {
                                 Botan::span<int> s;

                                 result.test_is_eq("begin() == end()", s.begin(), s.end());
                              }),
           Botan_Tests::CHECK("begin() with non-empty",
                              [](auto& result) {
                                 Botan::span<int> s(ARRAY);
           ...
           Botan_Tests::CHECK("rbegin() and rend() with empty",
                              [](auto& result) {
                                 Botan::span<int> s;

                                 result.test_is_eq("rbegin() == rend()", s.rbegin(), s.rend());
                              }),
           Botan_Tests::CHECK("rbegin() with non-empty",
                              [](auto& result) {
                                 Botan::span<int> s(ARRAY);
...
std::vector<Test::Result> test_observers() {
   return {Botan_Tests::CHECK("size()",
                              [](auto& result) {
                                 Botan::span<int> s(ARRAY);

                                 result.test_is_eq("size() gives span length", s.size(), ARRAY.size());
                              }),
           Botan_Tests::CHECK("size_bytes()",
                              [](auto& result) {
                                 Botan::span<int> s(ARRAY);

                                 result.test_is_eq(
                                    "size_bytes() gives span size in bytes", s.size_bytes(), sizeof(ARRAY));
                              }),
           Botan_Tests::CHECK("empty() with empty",
                              [](auto& result) {
                                 Botan::span<int> s;
...
std::vector<Test::Result> test_subviews() {
   return {Botan_Tests::CHECK("first(0) from empty",
                              [](auto& result) {
                                 Botan::span<int> s;
           ...
           Botan_Tests::CHECK("first(0) from non-empty",
                              [](auto& result) {
                                 Botan::span<int> s(ARRAY);
                                 auto sub = s.first(0UL);
           ...
           Botan_Tests::CHECK("first(1) from non-empty",
                              [](auto& result) {
                                 Botan::span<int> s(ARRAY);
           ...
           Botan_Tests::CHECK("first(SIZE) from non-empty",
                              [](auto& result) {
                                 Botan::span<int> s(ARRAY);
           ...
           Botan_Tests::CHECK("last(0) from empty",
                              [](auto& result) {
                                 Botan::span<int> s;
                                 auto sub = s.last(0UL);
           ...
           Botan_Tests::CHECK("last(0) from non-empty",
                              [](auto& result) {
                                 Botan::span<int> s(ARRAY);
                                 auto sub = s.last(0UL);
           ...
           Botan_Tests::CHECK("last(1) from non-empty",
                              [](auto& result) {
                                 Botan::span<int> s(ARRAY);
                                 auto sub = s.last(1UL);
           ...
           Botan_Tests::CHECK("last(SIZE) from non-empty",
                              [](auto& result) {
                                 Botan::span<int> s(ARRAY);
           ...
           Botan_Tests::CHECK("subspan(0, 0) from empty",
                              [](auto& result) {
                                 Botan::span<int> s;
           ...
           Botan_Tests::CHECK("subspan(0, 0) from non-empty",
                              [](auto& result) {
                                 Botan::span<int> s(ARRAY);
                                 auto sub = s.subspan(0UL, 0UL);
           ...
           Botan_Tests::CHECK("subspan(1, 0) from non-empty",
                              [](auto& result) {
                                 Botan::span<int> s(ARRAY);
           ...
           Botan_Tests::CHECK("subspan(1, 1) from non-empty",
                              [](auto& result) {
                                 Botan::span<int> s(ARRAY);
                                 ...
                                 result.test_is_eq(
                                    "subspan(1, 1) starts from second element", &(*sub.begin()), &ARRAY[1]);
                              }),
...
std::vector<Test::Result> test_non_member() {
   return {Botan_Tests::CHECK("as_bytes() from empty",
                              [](auto& result) {
                                 Botan::span<int> s;
                                 const auto const_bytes = Botan::as_bytes(s);

                                 result.confirm("as_bytes() gives empty span", const_bytes.empty(), true);
                              }),
           Botan_Tests::CHECK("as_writable_bytes() from empty",
                              [](auto& result) {
                                 Botan::span<int> s;
           ...
           Botan_Tests::CHECK("as_bytes() from non-empty",
                              [](auto& result) {
                                 Botan::span<int> s(ARRAY);
                                 const auto const_bytes = Botan::as_bytes(s);

                                 result.test_is_eq("as_bytes() gives sizeof(ARRAY) elements const span",
                                                   const_bytes.size(),
                                                   size_t(sizeof(ARRAY)));
                              }),
           Botan_Tests::CHECK("as_writable_bytes() from non-empty", [](auto& result) {
              ...
              result.test_is_eq("as_writable_bytes() gives sizeof(ARRAY) elements non-const span",
                                bytes.size(),
                                size_t(sizeof(ARRAY)));
           })};
}
...
std::vector<Test::Result> test_misc() {
   return {Botan_Tests::CHECK("implicit from std::vector",
                              [](auto& result) {
           ...
           Botan_Tests::CHECK("implicit from secure_vector",
                              [](auto& result) {
...
std::vector<Test::Result> test_span_detail() {
   return {
      Botan_Tests::CHECK(
         "is_span_convertible_v",
         [](auto& result) {
            result.confirm("is_span_convertible_v<int, int>", Botan::detail::is_span_convertible_v<int, int>, true);
            result.confirm(
               "is_span_convertible_v<int, const int>", Botan::detail::is_span_convertible_v<int, const int>, true);
            result.confirm("is_span_convertible_v<int, char>", Botan::detail::is_span_convertible_v<int, char>, false);
            result.confirm("is_span_convertible_v<int, unsigned int>",
                           Botan::detail::is_span_convertible_v<int, unsigned int>,
                           false);
            result.confirm(
               "is_span_convertible_v<int*, void*>", Botan::detail::is_span_convertible_v<int*, void*>, false);
         }),
      Botan_Tests::CHECK("is_dynamic_extent_v",
                         [](auto& result) {
                            result.confirm("is_dynamic_extent_v<0>", Botan::detail::is_dynamic_extent_v<0>, false);
                            result.confirm(
                               "is_dynamic_extent_v<100UL>", Botan::detail::is_dynamic_extent_v<100UL>, false);
                            result.confirm("is_dynamic_extent_v<Botan::dynamic_extent>",
                                           Botan::detail::is_dynamic_extent_v<Botan::dynamic_extent>,
                                           true);
                         }),
      Botan_Tests::CHECK(
         "is_span_capacity_v",
         [](auto& result) {
            ...
            result.confirm("is_span_capacity_v<dynamic_extent, 10>",
                           Botan::detail::is_span_capacity_v<Botan::dynamic_extent, 10>,
                           true);
         }),
      Botan_Tests::CHECK(
         "is_span_compatible_v",
         [](auto& result) {
            result.confirm(
               "is_span_compatible_v<int, 5, int, 5>", Botan::detail::is_span_compatible_v<int, 5, int, 5>, true);
            result.confirm(
               "is_span_compatible_v<int, 5, int, 10>", Botan::detail::is_span_compatible_v<int, 5, int, 10>, false);
            result.confirm("is_span_compatible_v<int, 5, const int, 5>",
                           Botan::detail::is_span_compatible_v<int, 5, const int, 5>,
                           false);
            result.confirm("is_span_compatible_v<int, dynamic_extent, int, 5>",
                           Botan::detail::is_span_compatible_v<int, Botan::dynamic_extent, int, 5>,
                           true);
            result.confirm("is_span_compatible_v<int, dynamic_extent, long, 5>",
                           Botan::detail::is_span_compatible_v<int, Botan::dynamic_extent, long, 5>,
                           false);
         }),
      Botan_Tests::CHECK(
         "is_span_explicit_v",
         [](auto& result) {
            ...
            result.confirm("is_span_explicit_v<dynamic_extent, 10>",
                           Botan::detail::is_span_explicit_v<Botan::dynamic_extent, 10>,
                           false);
            result.confirm("is_span_explicit_v<10, dynamic_extent>",
                           Botan::detail::is_span_explicit_v<10, Botan::dynamic_extent>,
                           true);
            result.confirm("is_span_explicit_v<dynamic_extent, dynamic_extent>",
                           Botan::detail::is_span_explicit_v<Botan::dynamic_extent, Botan::dynamic_extent>,
                           false);
         }),
      Botan_Tests::CHECK(
         "is_span_copyable_v",
         [](auto& result) {
            result.confirm(
               "is_span_copyable_v<int, 5, int, 10>", Botan::detail::is_span_copyable_v<int, 5, int, 10>, false);
            result.confirm(
               "is_span_copyable_v<int, 10, int, 10>", Botan::detail::is_span_copyable_v<int, 10, int, 10>, true);
            result.confirm("is_span_copyable_v<int, 5, int, dynamic_extent>",
                           Botan::detail::is_span_copyable_v<int, 5, int, Botan::dynamic_extent>,
                           true);
            result.confirm("is_span_copyable_v<int, 10, int, dynamic_extent>",
                           Botan::detail::is_span_copyable_v<int, 10, int, Botan::dynamic_extent>,
                           true);
            result.confirm("is_span_copyable_v<const int, 5, int, dynamic_extent>",
                           Botan::detail::is_span_copyable_v<const int, 5, int, Botan::dynamic_extent>,
                           true);
            result.confirm("is_span_copyable_v<const int, 10, int, dynamic_extent>",
                           Botan::detail::is_span_copyable_v<const int, 10, int, Botan::dynamic_extent>,
                           true);
            result.confirm("is_span_copyable_v<int, 10, long, dynamic_extent>",
                           Botan::detail::is_span_copyable_v<int, 10, long, Botan::dynamic_extent>,
                           false);
         }),
      Botan_Tests::CHECK(
         "is_span_v",
      ...
      Botan_Tests::CHECK(
         ...
         [](auto& result) {
            ...
            result.confirm(
               "is_std_array_v<std::array<int, 5>>", Botan::detail::is_std_array_v<std::array<int, 5>>, true);
      ...
      Botan_Tests::CHECK(
         ...
         [](auto& result) {
            ...
            result.confirm(
               "is_container_v<With_size_and_data<int>>", Botan::detail::is_container_v<With_size_and_data<int>>, true);
            result.confirm("is_container_v<std::string>", Botan::detail::is_container_v<std::string>, true);
            result.confirm(
               "is_container_v<std::array<int, 5>>", Botan::detail::is_container_v<std::array<int, 5>>, false);
      ...
      Botan_Tests::CHECK("is_container_type_compatible_v", [](auto& result) {
         result.confirm(
            "is_container_type_compatible_v<int, int>", Botan::detail::is_container_type_compatible_v<int, int>, false);
         result.confirm("is_container_type_compatible_v<Dummy<int>, int>",
                        Botan::detail::is_container_type_compatible_v<Dummy<int>, int>,
                        false);
         result.confirm("is_container_type_compatible_v<With_size_and_data<int>, float>",
                        Botan::detail::is_container_type_compatible_v<With_size_and_data<int>, float>,
                        false);
         result.confirm("is_container_type_compatible_v<With_size_and_data<int>, int>",
                        Botan::detail::is_container_type_compatible_v<With_size_and_data<int>, int>,
                        true);
         result.confirm("is_container_type_compatible_v<std::string, int>",
                        Botan::detail::is_container_type_compatible_v<std::string, int>,
                        false);
         result.confirm("is_container_type_compatible_v<std::array<int, 5>, const int>",
                        Botan::detail::is_container_type_compatible_v<std::array<int, 5>, const int>,
                        true);
         result.confirm("is_container_type_compatible_v<std::vector<int>, unsigned int>",
                        Botan::detail::is_container_type_compatible_v<std::vector<int>, unsigned int>,
                        false);
         result.confirm("is_container_type_compatible_v<Botan::span<int>, const int>",
                        Botan::detail::is_container_type_compatible_v<Botan::span<int>, const int>,
                        true);
         result.confirm("is_container_type_compatible_v<Botan::span<const int>, int>",
                        Botan::detail::is_container_type_compatible_v<Botan::span<const int>, int>,
                        false);
      })};
}
