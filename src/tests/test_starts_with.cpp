...
std::vector<Test::Result> test_starts_with()
    ...
    return 
        {
        Botan_Tests::CHECK("starts_with empty", [](auto &result)
            {
        ...
        Botan_Tests::CHECK("empty starts_with empty", [](auto &result)
            {
            std::string input{""};
        ...
        Botan_Tests::CHECK("empty starts_with non-empty", [](auto &result)
            {
            std::string input{""};
    
            result.confirm("not starts with", Botan::starts_with(input, "Hello"), false);
            }),
        Botan_Tests::CHECK("std::string starts_with", [](auto &result)
            {
            std::string input{"Hello, World!"};
        ...
        Botan_Tests::CHECK("starts_with std::string", [](auto &result)
            {
            std::string input{"Hello, World!"};
