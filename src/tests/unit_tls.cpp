...
class TLS_Unit_Tests final : public Test {
   private:
      ...
      static void test_all_versions(const std::string& test_descr,
         ...
         std::vector<Botan::TLS::Protocol_Version> versions = {Botan::TLS::Version_Code::TLS_V12,
      ...
      void test_session_established_abort(std::vector<Test::Result>& results,
         ...
         client_aborts(std::make_exception_ptr(
                          Botan::TLS::TLS_Exception(Botan::TLS::AlertType::AccessDenied, "some test TLS exception")),
         ...
         server_aborts(std::make_exception_ptr(
                          Botan::TLS::TLS_Exception(Botan::TLS::AlertType::AccessDenied, "some server test TLS exception")),
                       Botan::TLS::AlertType::AccessDenied);
         server_aborts(std::make_exception_ptr(
   ...
   public:
      std::vector<Test::Result> run() override {
         ...
         test_with_policy(
            "Suite B", results, client_ses, server_ses, creds, {Botan::TLS::Version_Code::TLS_V12}, suiteb_128);
